...
namespace Demo.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductID,ProductName,ShortDescription,Price,ImageURL,CreatedDate,CategoryID")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductID,ProductName,ShortDescription,Price,ImageURL,CreatedDate,CategoryID")] Book book)
        {
        ...
        {
          return (_context.Book?.Any(e => e.ProductID == id)).GetValueOrDefault();
        }
    }
}
